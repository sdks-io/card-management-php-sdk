...
| `name` | `?string` | Required | Name of Purchase category .<br><br>**Constraints**: *Maximum Length*: `30` | getName(): ?string | setName(?string name): void |
