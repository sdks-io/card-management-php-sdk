...
| `status` | [`string(DeliveryAddressUpdateStatusEnum)`](../../doc/models/delivery-address-update-status-enum.md) | Required | - | getStatus(): string | setStatus(string status): void |
