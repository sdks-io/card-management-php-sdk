...
| `statusDescription` | `?string` | Optional | Order status.<br /><br>Possible values<br /><br>Success<br /><br>Failed<br /><br>InProgress<br /> | getStatusDescription(): ?string | setStatusDescription(?string statusDescription): void |
