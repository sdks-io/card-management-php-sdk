...
| `cardSettings` | [`?ReplaceCardSettings`](../../doc/models/replace-card-settings.md) | Optional | Request entity object for ReplaceCardSettings | getCardSettings(): ?ReplaceCardSettings | setCardSettings(?ReplaceCardSettings cardSettings): void |
