...
class FleetmanagementV1CustomerPayers404ErrorException extends ApiException
{
    ...
    /**
     * Converts the FleetmanagementV1CustomerPayers404ErrorException object to a human-readable string
     * representation.
     *
     * @return string The string representation of the FleetmanagementV1CustomerPayers404ErrorException object.
     */
