...
class OAuthProviderException extends ApiException
{
    ...
    /**
     * @param string $reason
     * @param \ShellCardManagementAPIsLib\Http\HttpRequest $request
     * @param \ShellCardManagementAPIsLib\Http\HttpResponse $response
     * @param string $error
     */
    public function __construct(
        string $reason,
        \ShellCardManagementAPIsLib\Http\HttpRequest $request,
        \ShellCardManagementAPIsLib\Http\HttpResponse $response,
        string $error
    ) {
     ...
     * @required
     * @maps error
     * @factory \ShellCardManagementAPIsLib\Models\OAuthProviderErrorEnum::checkValue
     */
