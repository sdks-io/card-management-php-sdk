...
/**
 * Builder for model PINDeliveryAddress
 *
 * @see PINDeliveryAddress
 */
class PINDeliveryAddressBuilder
{
    /**
     * @var PINDeliveryAddress
     */
    private $instance;

    private function __construct(PINDeliveryAddress $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new PIN Delivery Address Builder object.
     *
    ...
    public static function init(
        ...
        return new self(new PINDeliveryAddress(
            $companyName,
            $addressId,
            $addressLine1,
            $zipCode,
    ...
    /**
     * Initializes a new PIN Delivery Address object.
     */
    public function build(): PINDeliveryAddress
    {
