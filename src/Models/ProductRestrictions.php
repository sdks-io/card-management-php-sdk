...
class ProductRestrictions implements \JsonSerializable
{
    /**
     * @var string[]|null
     */
     ...
     *
     * Optional. However, this field is mandatory when the Product restrictions are migrated to Gateway and
     * Product Groups are not provided.
     *
     * Example: [ "033", "021", "023" ]
     *
     * @return string[]|null
